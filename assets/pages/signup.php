    ...
    <div class="login">
        <div class="col-lg-4 col-md-8 col-sm-12 bg-white border rounded p-4 shadow-sm">
            <form method="post" action="assets/php/actions.php?signup">
                ...
                <h1 class="h5 mb-3 fw-normal">Build your Persona!</h1>
                <div class="d-flex">
                ...
                <div class="mt-3 d-flex justify-content-between align-items-center">
                    <button class="btn btn-primary" type="submit">Join the Party!</button>
                    <a href="?login" class="text-decoration-none">Got your Digital-License already?</a>
