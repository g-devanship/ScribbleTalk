...
<div class="modal fade" id="addpost" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Beam down a Fresh Post :</h5>
            ...
            <div class="modal-body">
                ...
                <form method="post" action="assets/php/actions.php?addpost" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Drop Knowledge :</label>
                        <textarea name="post_text" class="form-control" id="exampleFormControlTextarea1" rows="1"></textarea>
                    </div>
    
                <button type="submit" class="btn btn-primary">Spark!</button>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="notification_sidebar" aria-labelledby="offcanvasExampleLabel">
  <div class="offcanvas-header">
    <h5 class="offcanvas-title" id="offcanvasExampleLabel">Cosmic Alerts</h5>
...
?>
<span class="badge bg-danger">Firework Successfully Unsparked!</span>
<?php
}
                        ?>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="message_sidebar" aria-labelledby="offcanvasExampleLabel">
  <div class="offcanvas-header">
    <h5 class="offcanvas-title" id="offcanvasExampleLabel">Ripples</h5>
    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <i class="bi bi-x-octagon-fill"></i> Error 404: Friendship Not Found!
