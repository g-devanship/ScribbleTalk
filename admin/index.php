...
<head>
  ...
  <title>Scribble | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Scribble-Talk</span>
    </a>
...
<?php
  ...
  ?>
            ...
            <div class="card w-100">
              <div class="card-header">
                <h3 class="card-title">CrewMates Lists</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <?php
...
foreach($userslist as $user){
  ?>
   <tr>
                    ...
                    <a href="./php/admin_actions.php?userlogin=<?=$user['email']?>" target="_blank" class="btn btn-success btn-sm m-1">Beam-in As</a>
                    ...
                    <?php if($user['ac_status']==0): ?><button class="m-1 btn btn-warning btn-sm verify_user_btn" data-user-id="<?=$user['id']?>">Verify</button><?php endif; ?>
                        ...
                        <button style="display:<?=$user['ac_status']==1?'':'none'?>" class="m-1 btn btn-danger btn-sm block_user_btn ub" data-user-id="<?=$user['id']?>">Fizzle</button>
                        <button style="display:<?=$user['ac_status']==2?'':'none'?>" class="m-1 btn btn-primary btn-sm unblock_user_btn" data-user-id="<?=$user['id']?>">UnFizzle</button>
