    ...
    <div class="login">
        <div class="col-md-4 col-sm-11 bg-white border rounded p-4 shadow-sm">
            <form method="post" action="assets/php/actions.php?verify_email">
                ...
                <h1 class="h5 mb-3 fw-normal">Blast in the Verification Beam on (<?=$user['email']?>)</h1>


                <p>Enter your Verfication Beam!</p>
...
if(isset($_GET['resended'])){
    ?>
<p class="text-success">Verification Beam malfunction? We refired it! !</p>
